...
# preprocessing the data so we can use it for the model
...
def preprocess_data():
    ...
    # we drop unnecessary columns and 'Complain' as previously explained in exploration.ipynb.
    ...
    # I put replace here in case it need to be run again at some point to reset
    conn = sqlite3.connect(db_path)
